...
import { createWindow, getMainWindow, loadUrl, loadFile } from './window/manager'
...
async function setupApp(): Promise<void> {
  ...
  // Sync saved auto-start config to OS on every launch
  try {
    ...
    console.error('[App] Failed to sync auto-start setting:', error)
  }
