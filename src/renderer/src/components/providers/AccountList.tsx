                    ...
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-4 mt-1 text-xs text-muted-foreground">
                          ...
                          <span>总请求: {account.requestCount || 0}</span>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          {/* Show Clear Chats for qwen-ai, minimax, zai, perplexity, glm, and mimo providers */}
                          {(providerId === 'qwen-ai' || providerId === 'minimax' || providerId === 'zai' || providerId === 'perplexity' || providerId === 'glm' || providerId === 'mimo') && (
                            <>
                              <DropdownMenuSeparator />
                              <DropdownMenuItem 
                                onClick={(e) => {
